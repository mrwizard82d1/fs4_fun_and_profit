...
// wrong
//let anotherResult = 2 + 2; "hello"

// fixed
let anotherResult = 2 + 2 |> ignore; "hello"
...
let rnd2 = System.Random(x)     // Correct
...
let x0 = new MyResource()
// x.Dispose()


// The fix: cast the object to the interface.
(x0 :> System.IDisposable).Dispose()
